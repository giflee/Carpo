...
/* ---------------------------------------------------------------------- */
	...
	$.include('views/chahua3514/js/jquery.easing.1.3.js');
	$.include('views/chahua3514/js/jquery.cycle.all.min.js');
	$.include('views/chahua3514/js/respond.min.js');
	
	if(jQuery('.video-image').length) {
		$.include('views/chahua3514/fancybox/jquery.fancybox.pack.js');
	}
	
	//	Panel
	$.include('views/chahua3514/changer/js/changer.js');
	$.include('views/chahua3514/changer/js/colorpicker.js');
